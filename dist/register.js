...
function getTransformers(program, beforeConfig, afterDeclarationsConfig) {
    return Object.assign(Object.assign({}, (beforeConfig && { before: [transformer_1.default(program, beforeConfig)] })), (afterDeclarationsConfig && { afterDeclarations: [transformer_1.default(program, afterDeclarationsConfig)] }));
}
